...
Status: COMPLETE — archived from Relay pilot 1
...
## Acceptance criteria
- The branch's actual delta versus current `main` is fully inventoried and classified, including `docs/ROADMAP.md` and all overlapping docs changed on both sides since merge-base `3543f26`.
