...
## Legacy Head Line pillar cleanup, revision 9 — `blog/beginner/head-line.md` (Relay PP-RELAY-042, revision 9, 2026-08-23)

Revision 8 (PR #72, unmerged) rebuilt the cumulative cleanup of `src/content/blog/beginner/head-line.md` against actual `main` and was accepted as sound in substance; Director review found four residual source-boundary statements still exceeding the approved evidence boundary. Revision 9's authorized remediation is limited to those four residual items and directly equivalent wording found in the same focused pass; no other revision-8 wording was reopened. Revision 9 was reconstructed by taking `main`'s current `head-line.md` (confirmed identical to revision 8's own base — no intervening change to this file landed on `main`) and re-applying the full sound revision-8 diff, then making the six edits below.

**Claim-by-claim disposition of the residual and directly-equivalent passages:**

| Passage | Revision 8 wording | Disposition | Revision 9 wording |
|---|---|---|---|
| "Starting point" section opener | "This variation carries close traditional attention at the head line: it is one of the clearest features to observe, and the tradition is precise about what it suggests." | Not supported. No repository evidence establishes that this variation receives more traditional attention than the head line's other variables, or that "the tradition" is uniformly precise about it — an anonymous tradition-wide precision/consensus claim. Per required remediation item 3, removed rather than replaced with an equivalent unattributed claim. | "This is one of the clearest features to observe at the head line's origin." — states the directly observable fact only. |
| Length section, long/intelligent pairing | "The popular pairing of *long* with *intelligent* is a simplification the tradition does not support." | Not supported as a claim about what "the tradition" holds or how "popular" the pairing is. The underlying corrective point (length ≠ intelligence) is already independently supported two sentences earlier by the direct Benham quotation. Recast as Palmistry Path's own editorial statement per required remediation item 3. | "Palmistry Path does not treat *long* as a synonym for *intelligent*." |
| Writer's-fork naming/usage | "A fork at the end of the head line ... is a notable feature. In the popular Western tradition it is known as the \"writer's fork,\" and sometimes the \"lawyer's fork.\"" | Not supported. Cheiro/Benham non-use of either label does not establish who uses either name, how common either is, synonym status, chronology, or naming popularity, per the controlling task packet. Per required remediation item 1, the usage/prevalence/synonym claim is removed; the term is retained only as this site's own descriptive label for the feature, not as a tradition-wide naming claim. | "A fork at the end of the head line ... is a notable feature, referred to here as the writer's fork." |
| Writer's-fork naming rationale | "The interpretation behind the name is a capacity to see from more than one angle simultaneously — to balance practical and imaginative modes of thinking, to move between the concrete and the interior." | Not supported. No repository evidence verifies why the popular label arose. Per required remediation item 2, removed outright rather than narrowed, since Cheiro's verified `dual mentality` quotation (next sentence, unchanged) already stands on its own as Cheiro's reading without needing a naming-rationale bridge. | Sentence removed; the paragraph moves directly from the (now-neutral) naming reference to Cheiro's verified quotation. |
| FAQ — "What is the writer's fork?" | "It is associated with mental flexibility — the capacity to balance practical and imaginative modes of thinking." | Directly equivalent unattributed restatement of the naming-rationale claim removed from the main section above (same "practical and imaginative" framing, no source named). Per the packet's required-preflight instruction to check every writer's-fork mention (main section, FAQ, myths) and its "no risky phrase replaced by an equivalent unsupported synonym" check, replaced with the same verified Cheiro quotation used in the main section. | "Cheiro read it as giving \"more of what is called a dual mentality and less power of concentration on any one subject.\"" |
| Myths — "A fork means you're a writer" | "The writer's fork indicates mental flexibility and the capacity to work between registers." | Same directly-equivalent unattributed restatement, found during the required FAQ/myths inspection pass. Recast to attribute the "mental flexibility, not a talent bonus" reading to Cheiro specifically, consistent with the main section's revision-8 wording ("narrower than the popular version... mental flexibility, with a cost, not a talent bonus"), without repeating "popular" as an unqualified prevalence claim. | "Cheiro's reading of the writer's fork was narrower than the popular idea suggests: mental flexibility, not a talent bonus." |
| Breaks | "As with breaks on the other major lines, the classical reading is of transformation rather than catastrophe." | Not supported. No repository evidence establishes a "classical" cross-line consensus reading for breaks generally. Per required remediation item 3, recast as Palmistry Path's own editorial framing, matching the pattern already used elsewhere in this article (e.g. the overlapping-start variation). | "Palmistry Path reads a break here as marking transformation rather than catastrophe." |
| Myths — "A straight head line means you're not creative" | "The tradition distinguishes type of thinking, not its worth." | Not supported as an anonymous tradition-wide claim. Per required remediation item 3, recast as Palmistry Path's own editorial statement. | "Palmistry Path reads this as a difference in type of thinking, not its worth." |

**Preserved revision-8 boundary (unchanged, re-verified against the controlling evidence during this revision):** the Director-verified Benham straight/practical and sloping-toward-Luna/imagination direction boundary (`.ai-ops/evidence/PP-RELAY-041-benham-head-line-direction.md`); the verified Cheiro `dual mentality` fork quotation and its "narrower than the popular version... not a talent bonus" framing; the writer's-fork vocation/talent caution as Palmistry Path editorial policy, not a population claim; the IQ/cognitive-ability and mental-health cautions as Palmistry Path editorial policy, not tradition-wide consensus claims; the Benham writer/speaker historical-example framing for the steep Luna slope (no monotonic degree rule); and every other revision-8 removal/narrowing not listed in the table above.

**No new claim invented:** no prevalence, consensus, chronology, naming-history, population norm, population correlation/non-correlation, fixed cutoff, stronger-with-degree rule, scientific claim, medical/clinical claim, or combination reading was introduced by any of the seven edits above. No risky phrase was replaced by an equivalent unsupported synonym — the two FAQ/myths writer's-fork edits attribute the same underlying reading to Cheiro by name instead of leaving it unattributed.

**Claim-risk heuristic disposition:** `npm run audit:claim-risk -- src/content/blog/beginner/head-line.md` returns 5 findings, all pre-existing wording from revision 8 that this revision's authorized scope did not touch, none matching the four residual categories this task was authorized to fix: line 9/11 ("most important") are Cheiro's verified direct quotation/paraphrase, attributed by name; line 45 ("many angles") and line 110 ("many forms") are generic non-population phrasing, not claims about palmistry prevalence or consensus; line 49 ("usually") is inside a verified verbatim Cheiro quotation ("great brain workers usually have thin, fine, clean looking lines"), governed by quotation-fidelity rather than paraphrase rules. None is a naming/usage/popularity/synonym/rationale claim, and none is a tradition-wide anonymous-authority claim of the kind this revision was authorized to remove.

**Verification:** `npm run audit:claim-risk -- src/content/blog/beginner/head-line.md` (5 pre-existing findings, dispositioned above, none newly introduced). `npm run build` (110 pages). `npm run content-audit` (65 blog posts, 25 lessons valid). `npm run audit:all` (links — including the no-orphan check — images, schema, indexability, accessibility all pass). `git diff --check` (clean). Diff is bounded to `src/content/blog/beginner/head-line.md`, this log entry, `docs/CHANGELOG.md`, and the revision-9 result artifact. No other article, the claim-risk tooling, or unrelated legacy Head Line claims were touched.
