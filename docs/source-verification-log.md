...
## Legacy Head Line pillar — `blog/beginner/head-line.md` source-integrity cleanup, revision 3 (Relay PP-RELAY-042, revision 3, 2026-08-23)

Revisions 1 (PR #66) and 2 (PR #67) were both closed without merging. Director review of revision 2 found that, of the wording it had reasoned about, it correctly fixed eleven residual issues but incorrectly classified five population/comparative-prevalence passages as heuristic false positives or as outside this task's scope: `many people have it without any special literary ability`, `many capable writers do not have it at all`, `more common forks and branches`, the FAQ's `It appears in many hands, not exclusively in writers'`, and the myth section's `It appears across many kinds of hands, not only writers'`. Because none of revisions 1–2's edits ever reached `main`, this revision reconstructs all sound revision-1 and revision-2 corrections against current `main` in one pass and applies the required revision-3 remediation on top.

**Revision-1 and revision-2 corrections reconstructed and re-verified unchanged during this revision:** all nine revision-1 corrections (unattributed "consistent Western formulation" consensus claim; "classical writers... the longer... the longer" degree-scaling sentence; "generally the most positively read position" ranking claim; "other writers confirm"/"the wider the gap, the more strongly" anonymous-authority and degree-scaling pair; "classical texts"/"Contemporary writers have reframed this" anonymous-authority pair; the direction/path section's "the degree of slope matters... a more pronounced slope" degree-scaling sentence; the steep-slope paragraph's degree-scaling claim plus Cheiro's unauthorized "extreme morbid imagination" clinical framing, replaced with Benham's writer/poet examples framed explicitly as illustrations only; "Classical texts associated it with unusual mental capacity" vague-authority attribution; the FAQ's "the steeper the slope, the more dominant" degree-scaling sentence) and all eleven revision-2 corrections ("typically"/"usually" removed from the two origin-location sentences; the "discusses most specifically"/"the tradition is precise" ranking claim removed; the writer's-fork naming sentence reworded onto already-verified evidence from the sibling `forked-head-line-meaning.md` article, removing "among the most discussed" and "commonly called"; the unverifiable "one contemporary practitioner" quotation and its "notable frequency"/"which is how the name spread" prevalence/causal claims removed and the corrective point restated in the article's own voice; "generally" removed from the upward-branches reading; "uncommon" removed from the double-head-line description; the FAQ's "typically" removed; the myth section's "appears frequently in writers' hands" removed; the closing myth's "not how the contemporary tradition works" restated as the article's own stated position) are present in the current article text and were re-confirmed against `.ai-ops/evidence/PP-RELAY-041-benham-head-line-direction.md` during this revision.

**Revision-3 corrections (the five Director-identified residual population/comparative-prevalence passages):**

| Location | Passage before this revision | Why it is a population/comparative-prevalence claim despite the heuristic classification | Action |
|---|---|---|---|
| Writer's fork paragraph | "The fork does not track writing talent in either direction: many people have it without any special literary ability, and many capable writers do not have it at all." | Asserts, without repository evidence, how frequently the fork occurs among people generally and among writers specifically. No approved source establishes either population rate. | The frequency clauses were removed; the corrective point is now stated directly and logically ("does not track writing talent in either direction... neither its presence nor its absence indicates anything about creative potential") without asserting how common the feature is in any population, per the task's required framing. |
| Double head line paragraph | "It is worth distinguishing from the more common forks and branches that originate at or near the head line's endpoints." | "More common" ranks forks/branches against the double head line by prevalence; no repository evidence supports a comparative-prevalence ranking between these feature types. | "More common" removed. The distinguishing point is now made structurally, using only wording already established elsewhere in this same article (double head line = "a second line running parallel to or closely alongside the main one"; forks/branches = features that "originate at or near" an endpoint): "forks and branches, which originate at or near the head line's endpoints rather than running parallel to the main line for its length." No new claim introduced; no prevalence ranking retained. |
| FAQ — "What is the writer's fork?" | "It appears in many hands, not exclusively in writers'." | Asserts population frequency ("many hands") rather than only the non-exclusivity point. | Narrowed to "It is not exclusive to writers." — preserves the non-exclusivity point without a frequency claim. |
| Myth — "A fork means you're a writer." | "It appears across many kinds of hands, not only writers', and its absence does not prevent writing." | Same issue: "many kinds of hands" is a population-frequency claim layered onto a non-exclusivity point. | Narrowed to "It is not limited to writers, and its absence does not prevent writing." — same corrective content, no frequency claim. |

None of the four revision-3 edits above introduces a new palmistry meaning, an invented population statistic, or a replacement synonym carrying the same unsupported frequency claim (e.g., no substitution of "several," "a good number," "plenty of," or similar). Each is a direct, narrowed restatement of the same editorial point the passage already made.

**Independent re-scan for every remaining heuristic finding:** `npm run audit:claim-risk -- src/content/blog/beginner/head-line.md` returns 10 findings after this revision's edits (down from 14 before them). All ten were independently re-reviewed against the four cleanup categories, not merely carried forward from the revision-2 disposition:
- Lines 9, 11 ("most anxious attention" / "most persistent misreading" / Cheiro's "*the* most important line" / "the most important sign that can be found in the hand") — the first two are this article's own rhetorical scene-setting about reader/editorial attention across the four major-line articles, not a claim about hands or the tradition; the latter two are a direct, previously-verified Cheiro quotation attributed specifically to him (`Palmistry for All`, 1916), not an anonymous or population claim. Quotation fidelity requires the quoted wording be left unaltered.
- Line 17 ("among its most significant features") — Palmistry Path's own editorial statement of which features this article treats as worth close attention, not an external consensus or ranking claim; consistent with the same accepted framing pattern used elsewhere in this article's companion lessons.
- Line 45 ("considers many angles") — describes an individual mind's own range of interest ("a mind that... considers many angles"), not a claim about how common that range is across hands or people generally.
...
- Line 89 ("often where the most revealing observations occur") — Palmistry Path's own statement about its own cross-line reading method in the "head line in context" synthesis section, not an attributed tradition or population claim.
- Line 114 ("Creativity takes many forms") — a general editorial statement about creativity broadly, not a claim about palmistry population frequency.

No finding was dismissed solely because the heuristic flagged it as a possible false positive; each was checked against the article's actual sourced content and this task's four cleanup categories, per the task packet's instruction that "the task packet, not the heuristic, controls."

**No invented combination readings:** the "brief illustration" paragraph in "The head line in context" (moderately separated + slope-toward-Luna + fork, combined with a long curved heart line) is unchanged from revision 1 and remains explicitly framed as an illustration of the site's cross-line reading methodology ("None of this is a verdict. It is the beginning of an observation."), combining only individually-established readings from elsewhere in the same article. It does not assert a new fixed combination-meaning and was outside this revision's required remediation scope.

**Direction/path evidence boundary:** confirmed unchanged and re-verified against `.ai-ops/evidence/PP-RELAY-041-benham-head-line-direction.md`: straight-running head line → Benham/practical mentality; sloping toward Luna → Benham/imagination and departure from purely material thought; Benham's writer/poet examples remain historical illustrations only, with an explicit statement that a steeper or deeper slope is not evidenced to produce a stronger or more artistic result. This revision made no change to the direction/path passages themselves.

**Vague anonymous authority:** none remains in the four cleanup categories. "Classical texts" (writer's fork paragraph) is immediately followed by the specific, verified clarification "neither Cheiro nor Benham uses it," so it is not a free-floating unnamed-authority claim; "traditional interpretation" / "traditionally associated with" phrasing throughout the article follows this log's established, accepted convention for citing the tradition generally without inventing a named or anonymous authority.

**Quotation fidelity:** no quotation marks were added, removed, or altered by this revision. The pre-existing Cheiro/Benham quotations (lines 9, 11, 23, 37, 39, 41, 45, 49) are unchanged and remain the same previously-flagged Pass 1 (2026-08-10) gap — unverified against the original 1916/1900 texts, outside this task's four required cleanup categories, left for a dedicated quotation-verification task.
...
**Material source concerns outside the four cleanup categories:** none newly identified. The Pass 1 (2026-08-10) quotation-verification gap noted above remains logged and unexpanded.

**Verification:** `npm run audit:claim-risk -- src/content/blog/beginner/head-line.md` — 14 findings before this revision's edits → 10 after, all independently re-reviewed above as compliant, quoted, or genuine editorial framing, with the four revision-3 examples corrected regardless of heuristic classification. `npm run build` (110 pages), `npm run content-audit` (65 blog posts, 25 lessons valid), `npm run audit:all` (links — including the no-orphan check — images, schema, indexability, accessibility all pass), and `git diff --check` (clean) all pass. Diff is bounded to the reconstructed revision-1 and revision-2 corrections plus the four revision-3 corrected passages above, this log entry, `docs/CHANGELOG.md`, and the revision-3 result artifact. No curriculum scope, new companion article, claim-risk tooling, or unrelated article was touched.
