...
## Legacy Head Line pillar — `blog/beginner/head-line.md` source-integrity cleanup (Relay PP-RELAY-042, revision 1, 2026-08-22)

Closes the out-of-scope concern PP-RELAY-041 (revision 3) recorded above: the pillar still carried unsupported monotonic direction-degree wording and other prevalence/consensus, fixed-ranking, and anonymous-authority phrasing that the newer Head Line companion articles were explicitly prohibited from using. This is a bounded cleanup of the flagged categories, not a rewrite of the article's other interpretations.

**Claim-by-claim disposition:**

| Passage (pre-edit) | Category | Disposition |
|---|---|---|
| "This is the consistent Western formulation: the head line is about the quality and character of mind..." | Prevalence/consensus — explicitly named in the task packet | No repository evidence establishes cross-tradition consistency. Reworded to "That framing anchors this article: the head line is read for the quality and character of mind..." — states the site's own framing (grounded in the Benham quote immediately before it) with no consensus claim. |
| "The classical writers note that the longer the two lines remain joined before separating, the longer this period of influence tends to extend." | Monotonic degree extrapolation + vague plural authority | No source establishes this precise degree relationship, and "the classical writers" is an unattributed plural authority. Sentence removed; the paragraph's core claim (a joined start reads as caution/dependency) is unaffected. |
| "The moderate separation is generally the most positively read position in the Western tradition: initiative without recklessness." | Prevalence/ranking — explicitly named in the task packet | No source ranks this position against all others across "the Western tradition." Reworded to "That is a clearly positive reading: initiative without recklessness." — keeps the positive reading (grounded in the Cheiro quote immediately before it) without the unsupported ranking claim. |
| "...and other writers confirm this general reading." | Anonymous authority — explicitly named in the task packet | No specific source is identified. Sentence fragment removed; Cheiro's attributed "excessive impetuosity" quote is retained. |
| "The wider the gap, the more strongly this quality is associated." | Monotonic degree extrapolation (heuristic-flagged) | No source establishes a graduated gap-to-impetuosity scale. Sentence removed. |
| "...has been associated in classical texts with heightened sensitivity..." | Vague plural authority | "in classical texts" removed from the lead-in; the sentence now reads as a direct traditional association without an unattributed source claim. |
| "Contemporary writers have reframed this as indicating acute responsiveness... — and that is the framing this article uses." | Anonymous authority — explicitly named in the task packet | "Contemporary writers" is an invented unattributed group. Per the task's category 5 (Palmistry Path editorial policy may be stated as site policy when that is what is actually intended), reworded to state directly that this article uses a deliberately gentler frame than Cheiro's, removing the invented attribution while keeping the same gentler wording the article already used. |
| "The degree of slope matters: a gentle downward curve adds an imaginative colouring... a more pronounced slope indicates that imaginative and intuitive tendencies are dominant..." | Direction/path degree-scaling — explicitly prohibited by the task packet and the controlling evidence note | `.ai-ops/evidence/PP-RELAY-041-benham-head-line-direction.md` establishes Luna-sloping → imagination but explicitly states no monotonic degree rule is established. Sentence removed; the preceding sentence (slope toward Luna → imaginative/intuitive tendencies) is retained as within the evidence boundary. |
| "...intensifies this: the tradition associates it with a highly developed inner life, strong artistic or creative tendencies... Cheiro associated a sharply sloping head line with extreme morbid imagination... The underlying observation — that a very steeply sloping head line correlates with exceptional imaginative capacity... — remains within the tradition." | Direction/path degree-scaling + unauthorized clinical language | The evidence note is explicit that the creative/artistic degree rule is "not established as a monotonic degree rule" and that Benham's/Cheiro's clinical framing is "historical and unsafe for modern instructional use... unnecessary for this article." Reworded to: "is read within that same imaginative association. Benham noted writers, speakers, and poets among his examples of head lines that drooped toward Luna — illustrations of the type he was describing, not evidence that a steeper or deeper slope produces a stronger or more artistic result." This matches evidence-note point 3 (creative/literary examples may be mentioned as Benham's illustrations, without degree scaling) and drops the clinical language entirely rather than reframing it, per the evidence note's instruction that it is unnecessary here. |
| "Classical texts associated it with unusual mental capacity..." (double head line) | Vague plural authority | Reworded to "This has traditionally been associated with..." — matches the house "traditionally associated with" phrasing used throughout the rest of the article, removing the unattributed "classical texts" framing without asserting a new interpretation. |
| FAQ: "The steeper the slope, the more dominant those tendencies are in how the mind characteristically works." | Direction/path degree-scaling — explicitly named in the task packet | Same degree-scaling issue as the body-text instance above. Sentence removed; the FAQ answer now states only the supported association (Luna-sloping → imaginative/intuitive tendencies). |

**Findings reviewed and retained (not in scope for this cleanup):** the claim-risk heuristic's remaining 22 findings after these edits are prevalence-pattern words (`most`, `typically`, `usually`, `commonly`, `generally`, `often`, `many`) used either (a) inside direct attributed quotations from Cheiro (verbatim wording is not this task's editorial voice and quotation fidelity for these two passages was already flagged as unverified in the Pass 1 log above, an existing gap left for a dedicated quotation-verification task, not expanded here), (b) as anatomical/observational description of where the head line physically runs on the hand (not a palmistry-interpretation prevalence claim, and consistent with category 2's allowance for "purely observational comparative wording"), or (c) as editorial scene-setting about how much attention a feature receives in palmistry literature/discourse (e.g., "the variation Western palmistry discusses most," "among the most discussed special features") rather than a claim about hand-reading prevalence or consensus. None of these matches the task's explicitly named example phrasings, and none was left in place by oversight — each was individually reviewed against the task's six required cleanup categories and did not match any of them.

**No invented combination readings, no vague anonymous authority, no new palmistry meaning:** every edit above narrows or removes existing wording; none adds a new interpretive claim, prevalence estimate, combination reading, or unsupported attribution. The "head line + heart line" combination reading in "The head line in context" section and the illustrative example in the same section were reviewed and left unchanged: both use tentative "suggests"/"traditional associations" framing already consistent with house style, contain none of the six flagged categories, and fall under the task's explicit "cross-feature synthesis" out-of-scope carve-out.

**Direction/path evidence boundary:** every retained direction/path sentence was checked against `.ai-ops/evidence/PP-RELAY-041-benham-head-line-direction.md` — straight → practical mentality (evidence point 1), sloping toward Luna → imagination (evidence point 2), and Benham's writer/poet examples as illustrations only with no degree scaling (evidence point 3) — and none reintroduces the degree-scaling issue corrected in PP-RELAY-041's companion article.

**Quotation fidelity:** no quotation marks were added, changed, or relied upon newly by this revision. The two pre-existing Benham quotations on this page (lines 23 and 45, unchanged by this task) remain flagged as unverified in the Pass 1 (2026-08-10) table above; that is a pre-existing gap outside this task's six required cleanup categories, correctly left for a dedicated quotation-verification task rather than expanded here.

**Claim-type separation:** direct observation (starting-point/length/depth descriptions), named historical interpretation (Cheiro, Benham, attributed), and Palmistry Path's own editorial reframing (the "deliberately gentler frame" sentence, now explicitly self-attributed rather than misattributed to "contemporary writers") remain distinguishable.

**Safety boundaries:** removing the Cheiro "extreme morbid imagination" clinical framing eliminates the article's one unauthorized medical/clinical-adjacent phrase; no medical, legal, financial, or deterministic-relationship claim was introduced or remains.

**Verification:** `npm run audit:claim-risk -- src/content/blog/beginner/head-line.md` returns 22 findings, down from 26 before this revision (the four explicitly-named consensus/authority phrases and the one degree-extrapolation finding are gone); all 22 remaining findings are dispositioned above as reviewed-and-retained. `npm run build` (110 pages), `npm run content-audit` (65 blog posts, 25 lessons valid), `npm run audit:all` (links — including the no-orphan check — images, schema, indexability, accessibility all pass), and `git diff --check` (clean) all pass. Diff is bounded to the nine corrected passages in `head-line.md`, this log entry, `docs/CHANGELOG.md`, and the revision-1 result artifact; `docs/editorial-backlog.md` was reviewed and needed no correction (no status/note there is affected by this cleanup). No canonical lesson, claim-risk tooling, or other article was touched.
