...
## Status
No single active product-development priority is recorded in the canonical operating docs yet. `docs/ACTIVE_TASK.md` is currently inactive. Confirm the next priority with the user before promoting an item to active work.
