...
The previous lesson gave you the vocabulary for describing what a crease is doing. This one is about location: before you study what any line is traditionally associated with, you need to be able to find it reliably — to point to it, name it, and distinguish it from the lines beside it. That is the whole work here. Interpretation comes later, line by line, in the lessons that follow.
...
<Figure src="/images/lessons/lines/linesl101.webp" alt="Palm diagram labeling the heart line below the fingers, the head line across the middle palm, the life line around the base of the thumb, and the fate line rising toward the middle finger." caption="The four major lines of the palm. The fate line is the only one not present on all hands." />
...
<Figure src="/images/lessons/lines/linesl102.webp" alt="Palm diagram highlighting the heart line as the upper horizontal line beginning below the little finger and crossing toward the index-finger side." caption="The heart line: the uppermost of the major lines, running across the palm below the fingers." />
...
<Figure src="/images/lessons/lines/linesl103.webp" alt="Palm diagram highlighting the head line from the space between thumb and index finger across the middle of the palm toward the outer edge." caption="The head line: the second major horizontal line, running across the middle of the palm." />
...
You will read the life line for vitality, resilience, and the overall quality of physical energy — not for lifespan. Older writers such as Cheiro and Benham did read it for duration, and the life line lesson covers why that reading was dropped. For now, find the arc and trace it.

<Figure src="/images/lessons/lines/linesl104.webp" alt="Palm diagram highlighting the life line as an arc from the thumb-index web around the base of the thumb toward the wrist, enclosing the Mount of Venus." caption="The life line: an arc that curves around the base of the thumb, framing the mount of Venus." />
...
<Figure src="/images/lessons/lines/linesl105.webp" alt="Palm diagram showing one hand with a fate line rising from the wrist toward the middle finger and a second hand where the fate line is absent as a normal variation." caption="The fate line runs up the center of the palm. It is not present on all hands, and its absence has no significance." />
...
<Figure src="/images/lessons/lines/linesl106.webp" alt="Palm diagram showing the heart, head, life, and fate lines together so their relative positions and crossings can be compared." caption="All four major lines together: the map before interpretation begins." />
...
In contemporary Chinese palm reading, the three principal lines — heart, head, and life — are framed through the classical Chinese cosmological concept of *Tian Di Ren* (Heaven, Earth, Human): the heart line as Heaven, the head line as the Human line, and the life line as Earth. The *san cai* triad itself is well documented; the mapping of it onto these three lines is the terminology found in the contemporary Chinese palm-reading material we have consulted, and is not something this site has traced to a classical text.
...
<Practice title="Try it: find all four">
This is not a reading exercise — not yet. You now have the vocabulary to describe a line's condition, but you are not yet applying it to any particular line — and the variables that differ from line to line, such as length, path, and where a line ends, come in the lessons that follow, one line at a time.
