...
You are not reading anything in this lesson. You now have the vocabulary to describe a line's condition, but you are not yet applying it to any particular line — and the variables that differ from line to line, such as length, path, and where a line ends, come in the lessons that follow, one line at a time.
