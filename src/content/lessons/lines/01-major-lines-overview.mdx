...
<PalmDiagram variant="all-lines" caption="The four major lines of the palm. The fate line is the only one not present on all hands." />
...
<PalmDiagram variant="heart-line" caption="The heart line: the uppermost of the major lines, running across the palm below the fingers." />
...
<PalmDiagram variant="head-line" caption="The head line: the second major horizontal line, running across the middle of the palm." />
...
<PalmDiagram variant="life-line" caption="The life line: an arc that curves around the base of the thumb, framing the mount of Venus." />
...
<PalmDiagram variant="fate-line" caption="The fate line runs up the center of the palm. It is not present on all hands, and its absence has no significance." />
...
<PalmDiagram variant="all-lines" caption="All four major lines together: the map before interpretation begins." />
