...
This is a clearly observable variable in the head line, and it is one that is consistently read across the Western tradition.
...
A head line does not have to match one extreme or the other — a moderate downward slope is a normal middle case, and the question becomes one of degree rather than which category the line belongs to.
