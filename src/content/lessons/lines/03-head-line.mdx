...
<Figure src="/images/diagrams/head-line-length.svg" alt="Two palm diagrams compare a long head line reaching the outer palm with a short head line ending beneath the middle finger." caption="A long head line reaches toward the outer edge; a short one stops beneath the middle finger." />
...
<Figure src="/images/diagrams/head-line-forked.svg" alt="Two palm diagrams compare a head line with a single ending and a head line ending in the two-pronged writer’s fork." caption="The writer’s fork: the head line ends in two prongs, one level and one sloping." />
