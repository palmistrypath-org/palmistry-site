...
<PalmDiagram variant="head-line" caption="First locate the head line across the middle of the palm; the detailed comparisons below show how its origin and path can vary." />
