...
<Checkpoint title="Checkpoint — The Major Lines">
	...
	<CheckpointItem question="The hand in front of you has no fate line at all. What do you say?">
		That its absence is normal and carries no negative meaning. The fate line is the one major line genuinely not present on every hand. Traditionally its absence suggests that structure and settled direction are less the organising axis of this hand — not that the person lacks direction, purpose, or a future. It is also a good moment to say plainly that the line is about tendencies of direction rather than a fixed outcome.
	</CheckpointItem>
	<CheckpointItem question="A hand shows a deep, clear head line and a heart line that is chained across most of its length. Why is it a mistake to resolve that into a single tidy statement?">
		Because both observations are well supported, and they genuinely point in different directions. The honest reading names each one, anchored to what you can see, and leaves the tension standing rather than inventing a story that makes them agree. You will work on exactly this in the synthesis lesson later in the curriculum; for now it is enough to notice that a tidy answer here would be less accurate than an open one.
	</CheckpointItem>
</Checkpoint>
