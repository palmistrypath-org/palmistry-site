...
<Figure src="/images/diagrams/heart-line-length.svg" alt="Two palm diagrams compare a long heart line reaching the far side of the palm with a short heart line stopping beneath the ring finger." caption="Length is judged by where the line stops: beneath the index finger, or short of it." />
...
<Practice>
Describe your own heart line across the five variables this lesson covered: path (curved or straight), depth and clarity, length, endpoint, and any forks or branches. Write each down in a phrase or two — description only, no interpretation. If a meaning suggests itself as you go, set it aside and keep describing.
</Practice>
