...
<PalmDiagram variant="heart-line" caption="The heart line starts at the percussion edge. Its path across the palm — and where it ends — is what you are learning to read." />
