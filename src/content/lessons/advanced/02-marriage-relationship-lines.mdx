...
Later palmists moved against it. William Benham's *The Laws of Scientific Hand Reading* (1900) used the conventional term "line of union" — but Benham himself pushed past it: "More properly speaking, these are lines of deep affection rather than lines of marriage or union, and, viewed from this standpoint, they are remarkably accurate." Fred Gettings preferred "affection lines" in *The Book of the Hand* (1965), arriving independently at the same shift — a deliberate choice that decoupled the marking from the institution of marriage. Johnny Fincham's *The Spellbinding Power of Palmistry* (2005) states plainly that calling these "marriage lines" is misleading.
...
<Figure src="/images/diagrams/marriage-lines.svg" alt="Palm diagram with the marriage or relationship lines lit: short horizontal lines on the outer edge of the palm between the heart line and the little finger." caption="Marriage lines are read on the edge of the hand, between the heart line and the little finger." />
...
<Practice title="What to take away from your hand">
