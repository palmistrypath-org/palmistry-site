...
<Figure src="/images/diagrams/hand-map.svg" alt="Palm diagram naming the regions a reading works through: fingers, thumb, mounts, major lines, percussion, and wrist." caption="Weight travels from the whole hand inward: shape and fingers first, then mounts and major lines, minor markings last." />
