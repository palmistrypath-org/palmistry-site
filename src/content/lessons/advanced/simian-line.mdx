...
A small number of hands — commonly estimated at roughly one to three percent, though the figure varies by population — show something different. Where two lines would ordinarily run separately, there is a single horizontal crease crossing the full width of the palm. This is the simian line. Not two lines joined at an angle, not two lines close together, but one crease where two would ordinarily be. If that is what you see, this lesson is about you.
...
<Figure src="/images/lessons/lines/linesl601.webp" alt="Three hand diagrams compare a standard separate heart and head line, a single simian line crossing the palm, and a Sydney line with an unusually extended head line." caption="Three possible configurations. The simian line replaces two separate creases with one. The Sydney line is a different feature: the head line present but unusually extended." />
...
<Figure src="/images/lessons/lines/linesl602.webp" alt="Close-up palm diagram showing a simian line crossing where separate heart and head lines would ordinarily occupy the upper palm." caption="The simian line occupies the space where two separate lines would ordinarily run. The fusion replaces the usual separation between emotional and intellectual processing." />
...
**Depth and quality.** Apply the vocabulary you learned in [Line Quality and Markings](/learn/lines/line-quality-and-markings) — this lesson does not redefine it. A clearly defined, unbroken crease is associated with the pattern expressed consistently and with some force. A chained crease suggests variability: the intensity is present but less stable. A faint simian line indicates the same qualities in lesser degree. The terms carry exactly the meanings they carried on the major lines.
...
<Figure src="/images/lessons/lines/linesl603.webp" alt="Four simian-line diagrams compare high placement, low placement, a deep clear line, and a chained line quality." caption="Four variables to note when reading a simian line: placement (high or low), and quality (clear or chained). Each adds nuance to the core reading." />
...
## A contemporary Indian-tradition reading

Contemporary Indian-tradition practitioners often read this configuration through the concept of *ekāgratā* — single-pointed, undivided attention. The term itself is genuine, but it belongs to yogic and philosophical literature rather than to the classical hand-reading texts, and its application to the single transverse crease appears to be a modern cross-tradition reading rather than a doctrine traceable to *Hasta Samudrika Shastra* itself. Presented as ancient doctrine, it would overstate what the sources support.

Taken on its own terms, though, it is a useful framing: thought and feeling are not separated in such a person; they arrive together and reinforce each other, and the same unified focus that drives worldly accomplishment is what extended contemplative practice tries to cultivate deliberately — treating as a destination what the simian-line person carries as a starting point.

This reading does not view the simian line as a marker of difficulty or of special fortune. It is a constitutional observation: this person's mind and heart operate as a unit. The consequences of that — whether it serves them well or creates friction — depend entirely on what the unit is directed toward.
...
If you have a simian line, you have now read a formation that differs structurally from every other feature in the curriculum. The simian line is not a variant of the heart or head line reading — it replaces both with its own framework. The features you examine are different: placement, depth, quality, bilateral or unilateral expression.
...
<Practice>
Confirm which of the three configurations you actually have: two separate lines, a simian line, or a Sydney line. If you have the standard arrangement — true for the large majority of readers — your exercise is simply to hold the shape of a simian line clearly enough in mind to recognise it on someone else's hand, since that is where you are most likely to put this lesson to use. If you do have a simian line, go further: note its placement (high, toward where the heart line usually runs, or low, toward the head line's) and describe its quality using the Line Quality vocabulary — clean, chained, or faint — rather than assigning it a meaning.
</Practice>

---

**Lesson takeaway:** The simian line forms when the heart and head lines fuse into a single crease, replacing the standard two-line configuration. It is commonly estimated at roughly one to three percent of the population, with higher rates reported in some populations, and it carries no medical significance on its own. The core reading across the Western sources — echoed in contemporary Indian-tradition practice — is intensity of focus: feeling and thinking operate as a unit rather than independently, producing strong single-mindedness, deep commitment, and a corresponding difficulty with partial engagement or easy revision. Placement (high or low) describes which register leads in the fusion. Quality (clear or chained) describes its consistency. The Sydney line — an extended head line, not a merged crease — is a distinct feature and should not be confused with the simian line.
