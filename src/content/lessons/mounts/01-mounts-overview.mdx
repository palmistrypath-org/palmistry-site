...
<Figure src="/images/lessons/mounts/mounts-overview.svg" alt="Palm diagram locating the seven planetary mounts across eight mount regions — Jupiter, Saturn, Apollo, and Mercury beneath the fingers; Venus at the base of the thumb; Luna on the outer base of the palm; Upper and Lower Mars on either side; and the Plain of Mars in the centre." caption="The mount regions of the palm. Every mount lesson uses this same hand, so the landmarks stay put as you move from one region to the next." />
...
<Figure src="/images/diagrams/finger-names.svg" alt="Palm diagram labelling the thumb and the index, middle, ring, and little fingers with their planetary names Jupiter, Saturn, Apollo, and Mercury." caption="Four of the mounts sit beneath the fingers that share their planetary names." />
