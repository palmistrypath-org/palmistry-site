...
<PalmDiagram variant="mounts-overview" caption="The seven named mounts occupy nine teaching regions: Mars appears in two raised regions, and the Plain of Mars is the central field between them." />
