...
<Figure src="/images/lessons/mounts/mounts-overview.svg" alt="Diagram of a palm facing upward with all seven mounts labeled — Jupiter below the index finger, Saturn below the middle finger, Apollo below the ring finger, Mercury below the little finger, Venus at the base of the thumb, Luna at the lower outer palm, Lower Mars on the thumb-side inner edge, Upper Mars on the percussion outer edge, and the Plain of Mars as the central hollow between them." caption="The seven mounts of the palm: the full terrain before interpretation begins." />
