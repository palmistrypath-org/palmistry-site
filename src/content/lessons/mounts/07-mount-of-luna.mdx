...
<Figure src="/images/lessons/mounts/mount-of-luna.svg" alt="Palm diagram with the Mount of Luna highlighted on the outer base of the palm, opposite the Mount of Venus." caption="The Mount of Luna occupies the outer base of the palm, on the percussion side, opposite Venus." />
...
<Figure src="/images/diagrams/head-line-path.svg" alt="Two palm diagrams compare a straight head line crossing the palm with a sloping head line that curves down toward the Mount of Luna." caption="A straight head line crosses toward the percussion; a sloping one curves down toward Luna." />
...
<Practice>
Press your mount of Luna, in the lower outer palm below Mercury and Upper Mars, and note its firmness and how much it rises across that broad zone. Then press your mount of Venus at the base of the thumb and compare the two: which is more developed, and by how much? Venus and Luna sit at opposite poles of the lower palm, so reading one against the other is the comparison the tradition actually makes.
</Practice>
