...
<Figure src="/images/lessons/mounts/mount-of-apollo.svg" alt="Palm diagram with the Mount of Apollo highlighted directly beneath the ring finger." caption="The Mount of Apollo sits beneath the ring finger." />
...
The tradition reads the sun line and the Apollo mount together. A well-developed Apollo mount with a clear sun line is the configuration the classical texts describe with the most specificity. Cheiro, in *Palmistry for All* (1916), treated the sun line as a kind of endorsement of the mount — evidence that creative potential had found, or was finding, a form of expression in the world. He was considerably less gentle about the reverse case: on an otherwise well-marked hand, he held that a completely absent sun line meant that "no matter how clever or talented these people may be, the recognition of the world will be difficult or even impossible to gain." Palmistry Path reads this more mildly — we treat a prominent Apollo mount without a sun line as talent that has not yet found its outlet, or aesthetic sensitivity that has not crystallised into recognisable creative work, rather than as a verdict on whether recognition can ever arrive.
...
<Practice>
Press the mount of Apollo at the base of your ring finger and note whether it feels firm or soft, and how far it rises compared to the surrounding tissue. Then compare it to Saturn on one side and Mercury on the other: does Apollo clearly outrise both, sit roughly level, or fall behind one of them? Apollo's range runs wide across the population, so judge yours against its immediate neighbours rather than against what a "typical" Apollo mount might be.
</Practice>
