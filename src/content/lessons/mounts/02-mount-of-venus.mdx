...
<Figure src="/images/lessons/mounts/mount-of-venus.svg" alt="Palm diagram with the Mount of Venus highlighted as the large pad at the base of the thumb, inside the arc of the life line." caption="The Mount of Venus: the pad at the base of the thumb, bounded by the arc of the life line." />

## Its natural boundary

Venus does not just sit *at* the base of the thumb. It is enclosed by the arc of the life line.

<Figure src="/images/diagrams/life-line-arc.svg" alt="Two palm diagrams compare a wide life-line arc enclosing a large Mount of Venus with a narrow arc that hugs the thumb." caption="A wide arc encloses a large Mount of Venus; a narrow arc hugs the base of the thumb." />
...
Benham, writing in 1900, was specific about this: a life line lying close to the thumb "reduces the size of the Mount of Venus, thus checking the operation of that Mount" — while a wide arc leaves the mount fuller room to operate. Two hands with similarly padded flesh at the thumb base can read quite differently depending on how the life line carves out their territory. Take note of your own arc before you assess the mount's development — they are part of the same reading.
...
At the root, Venus is traditionally associated with **vitality**: the energetic reserve from which both physical strength and emotional warmth are drawn. Benham placed constitutional warmth at the centre of the Venus reading, writing that "as one of its greatest qualifications is attraction for its fellows, it necessarily needs warmth and heat." He understood the mount as describing the life-force available to a person — the energetic capital that feeds physical health and outward warmth alike.

Gettings, writing in *The Book of the Hand* (1965), extended this to include the general orientation toward sensory life: music, rhythm, physical pleasure, the appetite for engagement with the world. Cheiro, in *Palmistry for All* (1916), wrote that a well-formed Mount of Venus "denotes a desire for love and companionship, the desire to please, worship of beauty in every form, the artistic and emotional temperament" — the warmth toward others, the pleasure taken in connection, the affectionate quality that runs through a person's relationships with family and friends as much as with partners.
...
<Practice>
Locate your own mount of Venus — the padded flesh at the base of the thumb, inside the arc of your life line — and press it firmly. Note whether it feels firm and springy or soft and yielding, and how far it rises compared to the surrounding palm. Then compare it against Lower Mars, the narrow strip just inside your life line between Venus and Jupiter: is Venus clearly the more developed of the two, or does the difference feel slight? Development is read in relation to its neighbours, not on its own.
</Practice>
