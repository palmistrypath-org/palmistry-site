...
<Figure src="/images/lessons/mounts/mount-of-mars.svg" alt="Diagram of a palm facing upward with all three Mars regions highlighted in amber — Lower Mars as a narrow strip on the thumb-side inner edge inside the life line, Upper Mars at the percussion outer edge at mid-height, and the Plain of Mars as the central hollow between them. All other mounts appear faintly." caption="The three-part Mars complex: Lower Mars on the thumb-side inner edge, Upper Mars on the percussion outer edge, and the Plain of Mars at the centre." />
