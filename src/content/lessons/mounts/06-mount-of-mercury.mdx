...
<Figure src="/images/lessons/mounts/mount-of-mercury.svg" alt="Diagram of a palm facing upward with the mount of Mercury highlighted in amber at the base of the little finger at the percussion edge. All other mounts appear faintly. The Apollo mount is visible to the inner side, and the outer edge of the palm is clearly shown." caption="The mount of Mercury: at the outer percussion edge of the upper palm, the last of the four finger-base mounts." />
