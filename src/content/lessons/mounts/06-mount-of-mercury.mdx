...
<Figure src="/images/lessons/mounts/mount-of-mercury.svg" alt="Palm diagram with the Mount of Mercury highlighted directly beneath the little finger, at the top of the percussion edge." caption="The Mount of Mercury sits beneath the little finger, where the heart line begins." />
...
<Figure src="/images/diagrams/mercury-line.svg" alt="Palm diagram with the Mercury line lit, running from the base of the palm toward the little finger." caption="The Mercury line runs from the base of the palm toward the little finger." />
...
What makes the Mercury line structurally different from the sun line you encountered with Apollo is this: while a clear sun line reinforces the Apollo mount's associations in a straightforwardly positive way, the Mercury line's relationship to its mount is more ambiguous. The classical authors are explicit that the line's absence can be read positively — though it is Cheiro, not Benham, who makes this point. Cheiro, in *Palmistry for All* (1916), wrote that "it is an excellent sign to be without this line altogether. Its absence denotes an extremely robust, strong constitution, and a healthy state of the nervous system." Benham does not address the line's absence; his attention goes to the character of a line that is present, where a deep, well-marked Mercury line indicates to him good digestion, healthy liver action, good vitality, and a strong constitution. The absence of the Mercury line does not diminish the Mercury mount's communicative reading — the mount's associations are assessed from the mount itself, not from whether a line terminates there.
...
Benham placed the central Mercury quality in adaptability: the capacity to move quickly between subjects, people, and situations, to read a room accurately, and to communicate what has been read in a way that meets the moment. This is intelligence in motion — not the sustained analytical depth the tradition associates with a strong head line, and not the methodical structure Saturn governs, but the quick, connective intelligence that finds patterns across different domains and communicates them without friction. Benham also drew on a long-standing association between Mercury and the healing professions, reading a well-developed Mercury mount as consistent with rapid observation, synthesis under uncertainty, and the practical application of intelligence to a situation that keeps changing. That is a description of a quality of mind, not a statement about anyone's aptitude for a particular profession. One historical detail attached to this association is also worth correcting: Mercury's two-serpent caduceus is not the classical emblem of medicine — that is the single-serpent Rod of Asclepius — and the caduceus entered medical use only in the twentieth century, through a documented confusion between the two.

Cheiro emphasised verbal fluency and commercial intelligence. The Mercury type, in his framing, operates most naturally in the domains of exchange — trading not only in goods but in ideas, language, and social connection. He wrote that the mount "denotes all the mercurial qualities of life, love of change, travel, excitement, wit, quickness of thought and expression" — a quality that is specifically practical: it applies itself readily to problems of negotiation, communication, and quick situational assessment.
...
**Overdeveloped.** A Mercury mount conspicuously larger than the surrounding mounts — particularly when paired with soft tissue — carries the mount's associations into the territory the classical tradition explicitly names as negative. Benham was specific: an overdeveloped Mercury is associated with the strategic use of language — communication deployed to achieve an outcome the other party might not have accepted if fully informed; in its worst form, he wrote, even a good Mercurian "often degenerates from a sharp business man to a criminal, a liar and a thief." He distinguished this sharply from the well-developed form: the well-developed Mercury communicates quickly and honestly; the overdeveloped Mercury communicates quickly and manipulatively. Cheiro attached a related warning to marks on the mount: a cross on the Mount of Mercury, he wrote, "as a rule indicates a dishonest nature and one inclined to duplicity." The excess expression is not about volume of communication but about its orientation: the intelligence becomes strategic rather than connective, and words become instruments of advantage rather than exchange.
...
<Practice>
Press the mount of Mercury at the base of your little finger and note its firmness and elevation. Then compare it to the mount of Apollo just beside it, toward the ring finger: is Mercury clearly less developed, roughly even, or does it rise as much as or more than its neighbour? Because Mercury sits at the outer edge of the hand, Apollo is its only neighbour among the mounts beneath the fingers — though Upper Mars borders it directly below, on the percussion edge, and the boundary between the two is easy to lose. Press downward from Mercury until the ground changes, and note where you think it does.
</Practice>
