...
<Figure src="/images/lessons/mounts/mount-of-saturn.svg" alt="Palm diagram with the Mount of Saturn highlighted directly beneath the middle finger." caption="The Mount of Saturn sits beneath the middle finger, at the top of the fate line's course." />
...
Benham wrote that for the Saturnian, "prudence and caution are his watchwords," describing the type as "no shallow fellow, but is deep and a true scientist," engrossed in study while others spend their time in society. Cheiro, in *Palmistry for All* (1916), listed the mount's "chief characteristics" as "love of solitude, prudence, quiet determination, the study of serious sombre things, the belief in fatalism and in the ultimate destiny of all things" — the fatalism named there is the root of Saturn's traditional association with fate. Fincham, in *The Spellbinding Power of Palmistry* (2005), framed Saturn as the quality that makes sustained work possible: the capacity to endure, to remain with a task without needing constant external reward, to find meaning in difficulty.
...
**Overdeveloped.** A mount conspicuously larger than the surrounding mounts, particularly if dense or hard to the touch, carries Saturn's associations into excess. This is the configuration the classical texts treat most cautiously. Cheiro's rule for excess applies across all the mounts, Saturn included: an exaggerated mount, he wrote, "denotes an exaggeration of all the qualities it represents" — prudence into overcaution, solitude into isolation, seriousness into gloom. Benham was similarly wary of heavy development, describing the Saturnian as "not the one to be chosen if in any excessive degree of development." The philosophical depth becomes obsessive rumination; caution becomes paralysis; solitude becomes isolation. The distinction between a well-developed and an overdeveloped Saturn mount is proportion relative to the other mounts — size measured against the whole, not against an absolute standard.
...
<Figure src="/images/diagrams/fate-line.svg" alt="Palm diagram with the fate line lit, its start and end marked." caption="The fate line, when present, rises toward the Mount of Saturn." />
...
<Practice>
Press the mount of Saturn at the base of your middle finger and note its firmness and how much it rises — remembering that a flat Saturn is the ordinary finding, not a shortfall. Then compare it to its two neighbours: Jupiter on the thumb side and Apollo on the little-finger side. Is Saturn clearly the quietest of the three, or does it hold its own against one or both?
</Practice>
