...
<Figure src="/images/lessons/mounts/mount-of-jupiter.svg" alt="Palm diagram with the Mount of Jupiter highlighted directly beneath the index finger." caption="The Mount of Jupiter sits directly beneath the index finger." />
...
Benham, in *The Laws of Scientific Hand Reading* (1900), wrote that "ambition, love of command, pride in position, religion, honor, love of nature, are main forces with the Jupiterian." Cheiro, in *Palmistry for All* (1916), wrote that when the mount is large it shows "desire to dominate, to rule and command others, to lead and organise, and to carry out some distinct object." Gettings, in *The Book of the Hand* (1965), named leadership and "the sense of honour" as the defining core.
...
**Overdeveloped.** A mount significantly larger than the surrounding mounts, and especially if firm or hard to the touch, carries Jupiter's associations to excess. Cheiro wrote that when the Line of Head is poor and badly formed, a large Mount of Jupiter gives "pride, excess of vanity, a self-confident and a self-opinionated person." Benham read the type in excess as inclining "to the excess of a commanding disposition, which is tyranny or despotism" — a figure who "rules by fear, not love," ambition detached from the values of honour and justice that give Jupiter its legitimate ground. The desire for recognition becomes the desire for control. This is the reading commonly confused with the well-developed form; the distinction between them is proportion relative to the other mounts, not size alone.

**Flat or minimally developed.** A mount with little elevation at the index finger base is traditionally associated with reduced prominence of Jupiter's qualities — less orientation toward leadership and public standing, lower preoccupation with how one is regarded, rather than a deficiency. Many hands with flat Jupiter mounts carry strong development elsewhere: the imagination of Luna, the warmth of Venus, the communicative energy of Mercury. The mounts are read as a system, not scored individually.
...
<Practice>
Press the mount of Jupiter at the base of your index finger and note its firmness — springy and resilient, or soft and giving way easily — along with how far it rises above the surrounding palm. Then compare it to the mount of Saturn beside it, at the base of your middle finger: is Jupiter clearly the more developed of the two, roughly even, or does Saturn stand higher? Judge Jupiter against its neighbour, not against an abstract standard.
</Practice>
