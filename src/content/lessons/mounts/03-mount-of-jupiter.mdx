...
<Figure src="/images/lessons/mounts/mount-of-jupiter.svg" alt="Diagram of a palm facing upward with the mount of Jupiter highlighted in amber at the base of the index finger. All other mounts appear faintly. The heart line curves below the mount and the adjacent Saturn mount is visible to its inner side." caption="The mount of Jupiter: at the base of the index finger, the outermost of the four finger-base mounts." />
