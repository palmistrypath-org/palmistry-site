...
That last point requires immediate treatment, because the Mercury Line has an interpretive status unlike any other line covered in this series. Every other line's absence carries a neutral or qualified reading — the fate line absent suggests self-determined direction; the Sun Line absent means outer recognition isn't the hand's dominant feature. The Mercury Line is the one line whose absence is not merely neutral but traditionally considered a positive sign. Cheiro, across both *Palmistry for All* and *Cheiro's Language of the Hand*, was direct on the point: "it is an excellent sign to be without this line altogether," he wrote. "Its absence denotes an extremely robust, strong constitution, and a healthy state of the nervous system." Benham, by contrast, does not treat the line's absence — his attention goes to the character of a line that is present, and a deep, well-marked Mercury Line reads to him as a sign of good digestion, healthy liver function, and a strong constitution. On Cheiro's reading, then, the absence of a Mercury Line indicates robust good health — not a missing feature.
...
The Mercury Line is the one feature in Western palmistry where absence is explicitly stated by a major classical author as a positive indicator rather than a neutral one. Cheiro's position is the clearest: he treats the absence of a Mercury Line as indicating that the body's health functions are so well-regulated and untroubled that they leave no mark. "It is an excellent sign to be without this line," he wrote. "Such absence denotes an extremely robust, healthy constitution." Its presence, by contrast, he takes as marking "some delicate point to be guarded against."

Benham's treatment is different in kind, not merely in emphasis: he does not address the line's absence at all. His attention is on the character of a line that is present — a deep, well-marked Mercury Line, in his reading, indicates good digestion, healthy liver action, good vitality, and a strong constitution. This is not a case where the two authors simply agree with each other: Cheiro reads absence itself as favourable, while Benham's reading only engages once a line exists.
...
For how the Mercury Line fits alongside the Sun Line, the marriage lines, and the Girdle of Venus, see [the minor lines overview](/blog/beginner/minor-lines-overview).
