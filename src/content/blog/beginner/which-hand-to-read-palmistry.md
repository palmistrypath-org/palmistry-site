...
Cheiro set the convention out in *Palmistry for All* (1916), in his chapter on the right and left hands: because the nerves cross, the right is "this hand which denotes the developed or active brain, the left only giving the natural tendencies or inclinations." He added that something marked on the left hand and not the right stays a tendency in the nature and "will never bear fruit or come to any result." He was writing from the right-hand-dominant majority, but the principle applies symmetrically: whichever hand is passive holds what was given, whichever is active holds what has been made.
...
For a deeper exploration of how to read the two hands together, see the [Active and Passive Hand lesson](/learn/foundations/04-active-and-passive-hand) in the foundations module.
...
For a clear reference on the terminology, the [glossary entries for active hand](/glossary/#active-hand) and [passive hand](/glossary/#passive-hand) give brief definitions of how these terms are used across the site.
...
1. **Begin with the active hand** for your primary reading. This is the hand that has developed over the course of a life, and it is where the clearest picture of how someone has grown and changed typically emerges.

2. **Use the passive hand for comparison.** Once you have a sense of the active hand's features, look at the same features on the passive hand. Has something grown stronger? Faded? Appeared where it wasn't before?

3. **Pay attention to the differences.** Lines that are significantly deeper, clearer, or longer on the active hand than the passive may suggest development in that area. Lines that are stronger on the passive hand may suggest innate tendencies that haven't been fully expressed. A feature present on one hand and absent on the other is worth noting rather than explaining away.

The [complete beginner's guide to palmistry](/guide/) covers this in the context of the full reading sequence — hand shape first, then mounts, then lines — and why the order matters.

## Frequently asked questions

**Which palm should beginners read first?**
