...
Look carefully at your palm and you will find more than the broad creases most people think of as [palm lines](/blog/beginner/what-do-palm-lines-mean/). Scattered across the surface — on the mounts beneath each finger, along the lines, in the flat centre of the hand — are smaller markings. Among the most noticed are crosses and stars.
...
**Cross on the Mount of Jupiter.** Jupiter is associated with ambition, leadership, and social power — see the [mounts overview](/blog/beginner/mounts-overview/). A cross here is one of the more positively framed positions in the Western tradition. Both Cheiro (*Palmistry for All*, 1916) and Benham describe it in connection with a significant partnership or influential meeting, though Benham adds his characteristic caution about certainty.
...
**Reading markings before the hand.** The most common error is searching for mystic crosses or Apollo stars before understanding the major lines and mounts. The [guide](/guide/) covers this priority order. Markings modify context they cannot supply.
...
**Reading location without knowing the mounts.** A cross or star is only interpretable once you know which mount it sits on. The [mounts overview](/blog/beginner/mounts-overview/) is the necessary foundation.
...
**What does a cross mean in palmistry?**
...
**What does a star mean on the palm?**
A star is formed by three or more short lines meeting at a central point, and is generally considered more significant than a cross when clearly present. On Jupiter: traditionally associated with exceptional ambition realised. On Apollo: associated with sudden recognition, though Benham cautioned this is not purely positive. Stars on lines are typically treated as disruption markers.

**Do markings change meaning by location?**
Yes — this is the most important thing to understand. A cross on Jupiter and a cross on Saturn carry nearly opposite associations within the tradition. Location is not secondary; it is the primary interpretive variable.

**Should beginners focus on markings first?**
No. Benham, Gettings, and West all recommend learning major lines, hand shape, and mount development before working with markings. Markings modify context they cannot supply themselves. Start with the major lines; treat markings as a second layer.
